...
describe('Reto #2: Ponemos en marcha la fabrica', () => {
  const testCases = [
    createTestCase([['tren', 'oso', 'pelota'], 'tronesa'], ['tren', 'oso'], 'should return an array with tren and oso'),
    createTestCase([['juego', 'puzzle'], 'jlepuz'], ['puzzle'], 'should return an array with puzzle'),
  ];
